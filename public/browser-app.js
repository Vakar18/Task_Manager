...
const taskTitleDOM = document.querySelector('.task-title-input');
const taskDescDOM = document.querySelector('.task-desc-input');
...
formDOM.addEventListener('submit', async (e) => {
    ...
    try {
        await axios.post('/api/v1/tasks', { title, description });
        showTasks();
        taskTitleDOM.value = '';
        taskDescDOM.value = '';
